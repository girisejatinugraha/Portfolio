           ...
           <br/>
            ...
            <div className="text-2xl flex gap-4">
              <a
                ...
                href="https://github.com/girisejatinugraha/Landing-Page-Desain-Web"
                target="_blank"
              >
                <TbBrandGithub />
              </a>
        ...
        <div className="flex flex-col xl:flex-row-reverse gap-6">
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6 justify-between items-end text-right z-10">
            ...
            <div className="text-2xl flex gap-4">
              <a
                className="hover:text-yellow-500 duration-300"
                href="https://github.com/girisejatinugraha/Aplikasi-Absensi-Mahasiswa"
                target="_blank"
              >
                <TbBrandGithub />
              </a>
        ...
        <div className="flex flex-col xl:flex-row gap-6">
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6 justify-between items-end text-right xl:-ml-16 z-10">
            ...
            <div className="text-2xl flex gap-4">
              <a
                className="hover:text-yellow-500 duration-300"
                href="https://github.com/girisejatinugraha/Type-Merk-Televisi"
                target="_blank"
              >
                <TbBrandGithub />
              </a>
         ...
         <div className="flex flex-col xl:flex-row-reverse gap-6">
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6 justify-between items-end text-right z-10">
            ...
            <div className="text-2xl flex gap-4">
              <a
                className="hover:text-yellow-500 duration-300"
                href="https://github.com/girisejatinugraha/Perpustakaan"
                target="_blank"
              >
                <TbBrandGithub />
              </a>
         ...
         <div className="flex flex-col xl:flex-row gap-6">
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6 justify-between items-end text-right xl:-ml-16 z-10">
            ...
            <div className="text-2xl flex gap-4">
              <a
                className="hover:text-yellow-500 duration-300"
                href="https://github.com/girisejatinugraha/Aplikasi-Pemesanan-Hotel"
                target="_blank"
              >
                <TbBrandGithub />
              </a>
         ...
         <div className="flex flex-col xl:flex-row gap-6">
          ...
          <div className="w-full xl:w-1/2 flex flex-col gap-6 justify-between items-end text-right xl:-ml-16 z-10">
            ...
            <div className="text-2xl flex gap-4">
              <a
                className="hover:text-yellow-500 duration-300"
                href="https://github.com/girisejatinugraha/Website-Sekolah"
                target="_blank"
              >
                <TbBrandGithub />
              </a>
